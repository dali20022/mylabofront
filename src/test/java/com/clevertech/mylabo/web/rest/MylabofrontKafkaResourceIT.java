...
public class MylabofrontKafkaResourceIT {
    ...
    @Autowired
    private MylabofrontKafkaProducer producer;

    @Autowired
    private MylabofrontKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        MylabofrontKafkaResource kafkaResource = new MylabofrontKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/mylabofront-kafka/publish?message=test"))
